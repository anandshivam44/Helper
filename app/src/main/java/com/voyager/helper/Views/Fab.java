...
// */
//
//package com.voyager.helper.Views;
//
...
//public class Fab {
//
//  private static final long FAB_ANIMATION_TIME = 1000;
...
////        });
//
//    floatingActionsMenu.findViewById(R.id.fab_item_1).setOnClickListener(onClickListener);
//    floatingActionsMenu.findViewById(R.id.fab_item_2).setOnClickListener(onClickListener);
//
//    if (!expandOnLongClick) {
//      View noteBtn = floatingActionsMenu.findViewById(R.id.fab_item_3);
...
//    View overlayView = new View(Helper.getAppContext());
